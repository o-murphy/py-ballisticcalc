...
DRAG_TABLES = {
     ...
     # g1Curve = calculateCurve(g1Table)
     ...
     # g7Curve = calculateCurve(g7Table)
     ...
     # g2Curve = calculateCurve(g2Table)
     ...
     # g5Curve = calculateCurve(g5Table)
     ...
     # g6Curve = calculateCurve(g6Table)
     ...
     # g8Curve = calculateCurve(g8Table)
     ...
     # gICurve = calculateCurve(gITable)
     ...
     # gSCurve = calculateCurve(gSTable)
...
class BallisticCoefficient(object):
    ...
    def __init__(self, value: float, drag_table: int):
        ...
        if not self._error:
            self._drag_function = drag_function_factory(drag_table)
        else:
            self._drag_function = None


def drag_function_factory(drag_table: int) -> DragFunction:
    try:
        return DRAG_TABLES[drag_table]
    except KeyError:
