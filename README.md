...
| `python+euler`                | :arrow_down:    0.5x / 0.5x (slower) |            None             | Euler 1st-order integration                                     |                 [![tests](https://img.shields.io/github/actions/workflow/status/o-murphy/py-ballisticcalc/pytest-euler-engine.yml?logo=python&label=tests)](https://github.com/o-murphy/py-ballisticcalc/actions/workflows/pytest-euler-engine.yml)                  |
...
| `scipy+lsoda`                 | :arrow_up:  3.1x / 4.6x (faster)     |          `[scipy]`          | SciPy `solve_ivp`, Adams/BDF with automatic stiffness detection |                                                                                                                                  —                                                                                                                                   |
