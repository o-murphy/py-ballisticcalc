"""
Type stubs for the compiled extension module `py_ballisticcalc_exts.dopri_engine`
to improve IDE completion for the Cythonized Dormand-Prince 5(4) integration API.
"""
