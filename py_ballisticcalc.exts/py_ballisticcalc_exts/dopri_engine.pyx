...
cdef class CythonizedDormandPrinceIntegrationEngine(CythonizedBaseIntegrationEngine):
    ...
    def __cinit__(self, object config):
        ...
        self._this.integrate_func = BCLIBC_IntegrateCallable(BCLIBC_integrateDormandPrince)
    ...
    cdef BCLIBC_ShotProps* _init_trajectory(self, object shot_info):
        BCLIBC_dormandPrinceSetRelativeTolerance(self._relative_tolerance)
        BCLIBC_dormandPrinceSetAbsoluteTolerance(self._absolute_tolerance)
    ...
    def integrate(self, *args, **kwargs):
        ...
        BCLIBC_dormandPrinceGetStats(accepted, rejected)
