...
cdef extern from "include/interp.h":
    ...
    inline int _sign(double a) noexcept nogil
    inline void _sort3(double * xs, double * ys) noexcept nogil
    inline void _pchip_slopes3(double x0, double y0, double x1, double y1, double x2, double y2,
                        double * m0, double * m1, double * m2) noexcept nogil
    inline double _hermite(double x, double xk, double xk1, double yk, double yk1, double mk, double mk1) noexcept nogil
