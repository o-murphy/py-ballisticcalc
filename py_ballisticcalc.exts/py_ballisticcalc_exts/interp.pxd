cdef extern from "include/interp.h" nogil:
    ...
    # Internal nogil helpers for PCHIP used by base_traj_seq
    double interpolate_3_pt(double x, double x0, double x1, double x2, double y0, double y1, double y2) noexcept nogil
    int interpolate_2_pt(double x, double x0, double y0, double x1, double y1, double * result) except? -1 nogil
