...
extern "C"
{
     ...
     */
    BCLIBC_ErrorType BaseTrajSeq_t_append(BaseTrajSeq_t *seq, double time, double px, double py, double pz, double vx, double vy, double vz, double mach);
    ...
    BCLIBC_ErrorType BaseTrajSeq_t_get_at_slant_height(const BaseTrajSeq_t *seq, double look_angle_rad, double value, BaseTrajData_t *out);
    BCLIBC_ErrorType BaseTrajSeq_t_get_item(const BaseTrajSeq_t *seq, ssize_t idx, BaseTrajData_t *out);
    BCLIBC_ErrorType BaseTrajSeq_t_get_at(const BaseTrajSeq_t *seq, InterpKey key_kind, double key_value, double start_from_time, BaseTrajData_t *out);
