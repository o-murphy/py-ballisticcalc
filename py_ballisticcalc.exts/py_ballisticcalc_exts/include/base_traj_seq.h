...
extern "C"
{
    ...
    BCLIBC_ErrorType BCLIBC_BaseTrajSeq_getAtSlantHeight(const BCLIBC_BaseTrajSeq *seq, double look_angle_rad, double value, BaseTrajData_t *out);
    BCLIBC_ErrorType BCLIBC_BaseTrajSeq_getItem(const BCLIBC_BaseTrajSeq *seq, ssize_t idx, BaseTrajData_t *out);
    BCLIBC_ErrorType BCLIBC_BaseTrajSeq_getAt(const BCLIBC_BaseTrajSeq *seq, InterpKey key_kind, double key_value, double start_from_time, BaseTrajData_t *out);
