...
namespace bclibc
{
     ...
     * @return Reference to this vector for chaining.
     */
    BCLIBC_V3dT &BCLIBC_V3dT::fused_multiply_add(const BCLIBC_V3dT &other, double scalar)
    {
        x += other.x * scalar;
        y += other.y * scalar;
        z += other.z * scalar;
     ...
     * @return Reference to this vector for chaining.
     */
    BCLIBC_V3dT &BCLIBC_V3dT::fused_multiply_subtract(const BCLIBC_V3dT &other, double scalar)
    {
        x -= other.x * scalar;
        y -= other.y * scalar;
        z -= other.z * scalar;
     ...
     * @return Reference to this vector for chaining.
     */
    BCLIBC_V3dT &BCLIBC_V3dT::linear_combination(
     ...
     * @return Reference to this vector for chaining.
     */
    BCLIBC_V3dT &BCLIBC_V3dT::linear_combination_4(
     ...
     */
    double BCLIBC_V3dT::mag_squared() const
    {
        return (*this) * (*this);
    }
     ...
     * @return Reference to this vector for chaining.
     */
    BCLIBC_V3dT &BCLIBC_V3dT::normalize()
    {
        double m = mag();
        if (std::fabs(m) < 1e-10)
        {
