...
//     ssize_t n, i, start_idx, target_idx, center_idx;
//     BaseTrajC* buf;
//     double sft, epsilon, curr_val, next_val, a, b, a2, b2;
...
//         }
//         epsilon = 1e-9;
//         curr_val = _key_val_from_kind_buf(buf + start_idx, key_kind);
