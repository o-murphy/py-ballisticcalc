                                   ...
                                   BaseTrajSeq_t *traj_seq_ptr)
{
    ...
    while (range_vector.x <= range_limit_ft || integration_step_count < 3)
    {
        ...
        if (velocity < _cMinimumVelocity || (velocity_vector.y <= 0 && range_vector.y < _cMaximumDrop) || (velocity_vector.y <= 0 && shot_props_ptr->alt0 + range_vector.y < _cMinimumAltitude))
        {
