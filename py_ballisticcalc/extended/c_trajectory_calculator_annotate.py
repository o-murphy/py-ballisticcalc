...
cZeroFindingAccuracy: cython.py_float = 0.000005
cMinimumVelocity: cython.py_float = 50.0
cMaximumDrop: cython.py_float = -15000
cMaxIterations: cython.py_int = 10
cGravityConstant: cython.py_float = -32.17405


class CTrajectoryCalculator(object):
    """
    ...
    def get_calculation_step(self, step: cython.py_float) -> float:
        step: cython.py_float
        maximum_step: cython.py_float
        step_order: cython.py_int
        maximum_order: cython.py_int

        step = step / 2  # do it twice for increased accuracy of velocity calculation and 10 times per step
        maximum_step = self._maximum_calculator_step_size.get_in(unit.DistanceFoot)
    ...
    def sight_angle(self, ammunition: Ammunition, weapon: Weapon, atmosphere: Atmosphere) -> unit.Angular:
        ...
        calculation_step: cython.py_float
        mach: cython.py_float
        density_factor: cython.py_float
        muzzle_velocity: cython.py_float
        barrel_azimuth: cython.py_float
        barrel_elevation: cython.py_float
        iterations_count: cython.py_int
        zero_finding_error: cython.py_float
        velocity: cython.py_float
        time: cython.py_float
        zero_distance: cython.py_float
        maximum_range: cython.py_float
        delta_time: cython.py_float
        velocity: cython.py_float
        zero_finding_error: cython.py_float
        barrel_elevation: cython.py_float
        iterations_count: cython.py_int
