...
from py_ballisticcalc.trajectory_calc import TrajectoryCalc, _TrajectoryDataFilter, _WindSock, create_trajectory_row
...
class TrajectoryCalcRK4(TrajectoryCalc):
    ...
    def _integrate(self, shot_info: Shot, maximum_range: float, record_step: float,
        ...
        while (range_vector.x <= maximum_range + min_step) or (filter_flags and last_recorded_range <= maximum_range - 1e-6):
            it += 1
